...
void Quad(vec3 p1, vec3 p2, vec3 p3, vec3 p4, GLuint textureName, int textureUnit, int nChannels) {
	QuadInner(p1, p2, p3, p4, true, vec3(0,0,0), 1, 1, true, textureName, textureUnit, nChannels);
}
